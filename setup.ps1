...
if (!(Test-Path -Path $PROFILE -PathType Leaf)) {
  try {
    ...
    Invoke-RestMethod https://github.com/RoBaertschi/powershell-profile/raw/master/Microsoft.PowerShell_profile.ps1 -OutFile $PROFILE
...
try {
  ...
  if ($fontFamilies -notcontains "JetBrainsMono NF") {
    ...
    $webClient.DownloadFileAsync((New-Object System.Uri($fonturl)), ".\JetBrainsMono.zip")
